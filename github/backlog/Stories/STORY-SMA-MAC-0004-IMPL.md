# STORY-SMA-MAC-0004-IMPL: Implement GDP, CPI, interest rates, PMI, employment, central bank decisions

Type: Story

Story Id: STORY-SMA-MAC-0004-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-MAC-0004
...
Architecture Component: Global Macro Engine, Event Intelligence

Initiative: I02 Market Intelligence Platform; I09 News and Sentiment Platform

Epic: I02-E03; I09-E05

Feature: RBI/Fed calendar, CPI, NFP, macro news

Business Goal: Deliver implementation story coverage for GDP, CPI, interest rates, PMI, employment, central bank decisions while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for GDP, CPI, interest rates, PMI, employment, central bank decisions.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-MAC-0004.
...
- Implementation Story evidence exists for SMA-MAC-0004.
...
Implementation Notes: Macro service, validation fixtures, API endpoint, database table, dashboard component, test suite

# STORY-SMA-KNW-0006-VAL: Validate Kite session expiry handling

Type: Story

Story Id: STORY-SMA-KNW-0006-VAL
...
Business Goal: Deliver validation story coverage for Kite session expiry handling while preserving source-backed governance.
...
- Validation Story evidence exists for SMA-KNW-0006.

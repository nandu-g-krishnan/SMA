# STORY-SMA-FUT-0004-IMPL: Implement Cost of Carry

Type: Story

Story Id: STORY-SMA-FUT-0004-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-FUT-0004
...
Feature: Cost of Carry capability

Business Goal: Deliver implementation story coverage for Cost of Carry while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Cost of Carry.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-FUT-0004.
...
- Implementation Story evidence exists for SMA-FUT-0004.

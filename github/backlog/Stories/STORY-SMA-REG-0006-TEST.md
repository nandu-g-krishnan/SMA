# STORY-SMA-REG-0006-TEST: Test Risk Off

Type: Story

Story Id: STORY-SMA-REG-0006-TEST
...
Business Goal: Deliver testing story coverage for Risk Off while preserving source-backed governance.
...
- Testing Story evidence exists for SMA-REG-0006.

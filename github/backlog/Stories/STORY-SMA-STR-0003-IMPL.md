# STORY-SMA-STR-0003-IMPL: Implement Straddle, strangle, iron condor, butterfly, calendar, ratio, synthetic positions

Type: Story

Story Id: STORY-SMA-STR-0003-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-STR-0003
...
Architecture Component: Strategy Registry, Payoff Engine

Initiative: I04 Options and Futures Platform

Epic: I04-E03; I04-E06

Feature: Iron condor, payoff engine, options replay

Business Goal: Deliver implementation story coverage for Straddle, strangle, iron condor, butterfly, calendar, ratio, synthetic positions while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Straddle, strangle, iron condor, butterfly, calendar, ratio, synthetic positions.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-STR-0003.
...
- Implementation Story evidence exists for SMA-STR-0003.
...
Implementation Notes: Options Strategy service, validation fixtures, API endpoint, database table, dashboard component, test suite

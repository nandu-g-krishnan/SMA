# STORY-SMA-CAN-0006-IMPL: Implement Harami

Type: Story

Story Id: STORY-SMA-CAN-0006-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-CAN-0006
...
Feature: Harami capability

Business Goal: Deliver implementation story coverage for Harami while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Harami.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-CAN-0006.
...
- Implementation Story evidence exists for SMA-CAN-0006.

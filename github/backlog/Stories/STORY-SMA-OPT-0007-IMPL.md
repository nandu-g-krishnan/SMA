...
Story Id: STORY-SMA-OPT-0007-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-OPT-0007
...
Feature: Iron Condor capability

Business Goal: Deliver implementation story coverage for Iron Condor while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Iron Condor.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-OPT-0007.
...
- Implementation Story evidence exists for SMA-OPT-0007.

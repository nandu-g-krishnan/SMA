# STORY-SMA-OPT-0012-IMPL: Implement Straddle

Type: Story

Story Id: STORY-SMA-OPT-0012-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-OPT-0012
...
Feature: Straddle capability

Business Goal: Deliver implementation story coverage for Straddle while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Straddle.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-OPT-0012.
...
- Implementation Story evidence exists for SMA-OPT-0012.

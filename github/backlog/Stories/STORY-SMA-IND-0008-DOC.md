# STORY-SMA-IND-0008-DOC: Document EMA

Type: Story

Story Id: STORY-SMA-IND-0008-DOC
...
Business Goal: Deliver documentation story coverage for EMA while preserving source-backed governance.
...
- Documentation Story evidence exists for SMA-IND-0008.

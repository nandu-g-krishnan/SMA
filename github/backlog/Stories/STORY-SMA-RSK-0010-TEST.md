# STORY-SMA-RSK-0010-TEST: Test Stop Loss

Type: Story

Story Id: STORY-SMA-RSK-0010-TEST
...
Business Goal: Deliver testing story coverage for Stop Loss while preserving source-backed governance.
...
- Testing Story evidence exists for SMA-RSK-0010.

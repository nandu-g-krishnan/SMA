# STORY-SMA-BRD-0006-IMPL: Implement New Highs Lows

Type: Story

Story Id: STORY-SMA-BRD-0006-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-BRD-0006
...
Feature: New Highs Lows capability

Business Goal: Deliver implementation story coverage for New Highs Lows while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for New Highs Lows.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-BRD-0006.
...
- Implementation Story evidence exists for SMA-BRD-0006.

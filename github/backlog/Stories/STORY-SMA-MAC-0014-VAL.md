# STORY-SMA-MAC-0014-VAL: Validate USDINR

Type: Story

Story Id: STORY-SMA-MAC-0014-VAL
...
Business Goal: Deliver validation story coverage for USDINR while preserving source-backed governance.
...
- Validation Story evidence exists for SMA-MAC-0014.

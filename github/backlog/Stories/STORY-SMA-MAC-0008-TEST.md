# STORY-SMA-MAC-0008-TEST: Test RBI Events

Type: Story

Story Id: STORY-SMA-MAC-0008-TEST
...
Business Goal: Deliver testing story coverage for RBI Events while preserving source-backed governance.
...
- Testing Story evidence exists for SMA-MAC-0008.

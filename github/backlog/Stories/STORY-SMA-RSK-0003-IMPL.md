# STORY-SMA-RSK-0003-IMPL: Implement Expected Shortfall

Type: Story

Story Id: STORY-SMA-RSK-0003-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-RSK-0003

Knowledge Source: Governance

Source Document: The-Complete-Guide-to-Trading.pdf; mtm_251058.pdf; My Learnings - Profitable Trading Strategies.pdf
...
Feature: Expected Shortfall capability

Business Goal: Deliver implementation story coverage for Expected Shortfall while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Expected Shortfall.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-RSK-0003.
...
- Implementation Story evidence exists for SMA-RSK-0003.

# STORY-SMA-MAC-0012-VAL: Validate US CPI

Type: Story

Story Id: STORY-SMA-MAC-0012-VAL
...
Business Goal: Deliver validation story coverage for US CPI while preserving source-backed governance.
...
- Validation Story evidence exists for SMA-MAC-0012.

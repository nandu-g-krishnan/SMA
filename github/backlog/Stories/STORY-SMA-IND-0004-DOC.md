# STORY-SMA-IND-0004-DOC: Document ATR

Type: Story

Story Id: STORY-SMA-IND-0004-DOC
...
Business Goal: Deliver documentation story coverage for ATR while preserving source-backed governance.
...
- Documentation Story evidence exists for SMA-IND-0004.

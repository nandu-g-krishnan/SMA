# STORY-SMA-MLQ-0009-TEST: Test ML features, model training, validation, drift

Type: Story

Story Id: STORY-SMA-MLQ-0009-TEST
...
Business Goal: Deliver testing story coverage for ML features, model training, validation, drift while preserving source-backed governance.
...
- Testing Story evidence exists for SMA-MLQ-0009.

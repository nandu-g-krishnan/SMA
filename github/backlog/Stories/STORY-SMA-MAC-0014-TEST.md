# STORY-SMA-MAC-0014-TEST: Test USDINR

Type: Story

Story Id: STORY-SMA-MAC-0014-TEST
...
Business Goal: Deliver testing story coverage for USDINR while preserving source-backed governance.
...
- Testing Story evidence exists for SMA-MAC-0014.

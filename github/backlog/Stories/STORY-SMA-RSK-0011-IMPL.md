# STORY-SMA-RSK-0011-IMPL: Implement Stop loss, trailing stop, risk/reward, capital preservation

Type: Story

Story Id: STORY-SMA-RSK-0011-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-RSK-0011

Knowledge Source: Governance

Source Document: The-Complete-Guide-to-Trading.pdf; mtm_251058.pdf

Source Page: Document-level reference recorded in extraction audit; page-specific review logged in GapAnalysis

Architecture Component: Risk Engine, Stops and Sizing

Initiative: I07 Portfolio and Risk Platform

Epic: I07-E03 Stops and sizing; I07-E04 Drawdown control

Feature: ATR stop, support/resistance stop, trailing stop, daily loss limit

Business Goal: Deliver implementation story coverage for Stop loss, trailing stop, risk/reward, capital preservation while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Stop loss, trailing stop, risk/reward, capital preservation.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-RSK-0011.
...
- Implementation Story evidence exists for SMA-RSK-0011.

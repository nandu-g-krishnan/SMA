# STORY-SMA-MAC-0001-IMPL: Implement Sector rotation

Type: Story

Story Id: STORY-SMA-MAC-0001-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-MAC-0001
...
Architecture Component: Sector Rotation Engine, Market Intelligence Scoring

Initiative: I02 Market Intelligence Platform

Epic: I02-E06 Sector rotation

Feature: Sector map, relative strength, rotation signal, sector regime

Business Goal: Deliver implementation story coverage for Sector rotation while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Sector rotation.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-MAC-0001.
...
- Implementation Story evidence exists for SMA-MAC-0001.
...
Implementation Notes: Institutional Flow/Macro service, validation fixtures, API endpoint, database table, dashboard component, test suite

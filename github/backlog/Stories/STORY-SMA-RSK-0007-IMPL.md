# STORY-SMA-RSK-0007-IMPL: Implement Position Sizing

Type: Story

Story Id: STORY-SMA-RSK-0007-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-RSK-0007
...
Business Goal: Deliver implementation story coverage for Position Sizing while preserving source-backed governance.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-RSK-0007.
...
- Implementation Story evidence exists for SMA-RSK-0007.

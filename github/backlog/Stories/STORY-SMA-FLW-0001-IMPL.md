# STORY-SMA-FLW-0001-IMPL: Implement FII and DII flows

Type: Story

Story Id: STORY-SMA-FLW-0001-IMPL
...
Epic: I02-E04 FII/DII tracking

Feature: FII ingestion, DII ingestion, net flow calculation, flow dashboard

Business Goal: Deliver implementation story coverage for FII and DII flows while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for FII and DII flows.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-FLW-0001.
...
- Implementation Story evidence exists for SMA-FLW-0001.
...
Implementation Notes: Institutional Flow service, validation fixtures, API endpoint, database table, dashboard component, test suite

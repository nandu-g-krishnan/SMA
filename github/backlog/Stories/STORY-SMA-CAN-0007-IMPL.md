...
Story Id: STORY-SMA-CAN-0007-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-CAN-0007
...
Feature: Marubozu capability

Business Goal: Deliver implementation story coverage for Marubozu while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Marubozu.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-CAN-0007.
...
- Implementation Story evidence exists for SMA-CAN-0007.

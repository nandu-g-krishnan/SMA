# STORY-SMA-RSK-0008-IMPL: Implement Position sizing and account risk

Type: Story

Story Id: STORY-SMA-RSK-0008-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-RSK-0008
...
Architecture Component: Position Sizing Engine

Initiative: I07 Portfolio and Risk Platform

Epic: I07-E03 Stops and sizing

Feature: Position sizing

Business Goal: Deliver implementation story coverage for Position sizing and account risk while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Position sizing and account risk.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-RSK-0008.
...
- Implementation Story evidence exists for SMA-RSK-0008.

# STORY-SMA-MLQ-0009-VAL: Validate ML features, model training, validation, drift

Type: Story

Story Id: STORY-SMA-MLQ-0009-VAL
...
Business Goal: Deliver validation story coverage for ML features, model training, validation, drift while preserving source-backed governance.
...
- Validation Story evidence exists for SMA-MLQ-0009.

# STORY-SMA-MLQ-0019-VAL: Validate Statistical validation, cross validation, significance testing

Type: Story

Story Id: STORY-SMA-MLQ-0019-VAL
...
Business Goal: Deliver validation story coverage for Statistical validation, cross validation, significance testing while preserving source-backed governance.
...
- Validation Story evidence exists for SMA-MLQ-0019.

# STORY-SMA-RSK-0012-IMPL: Implement Value at Risk

Type: Story

Story Id: STORY-SMA-RSK-0012-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-RSK-0012
...
Feature: Value at Risk capability

Business Goal: Deliver implementation story coverage for Value at Risk while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Value at Risk.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-RSK-0012.
...
- Implementation Story evidence exists for SMA-RSK-0012.

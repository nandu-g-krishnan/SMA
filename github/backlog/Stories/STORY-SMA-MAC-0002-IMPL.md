# STORY-SMA-MAC-0002-IMPL: Implement Crude Oil

Type: Story

Story Id: STORY-SMA-MAC-0002-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-MAC-0002
...
Feature: Crude Oil capability

Business Goal: Deliver implementation story coverage for Crude Oil while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Crude Oil.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-MAC-0002.
...
- Implementation Story evidence exists for SMA-MAC-0002.

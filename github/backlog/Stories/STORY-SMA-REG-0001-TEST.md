# STORY-SMA-REG-0001-TEST: Test Event Risk

Type: Story

Story Id: STORY-SMA-REG-0001-TEST
...
Business Goal: Deliver testing story coverage for Event Risk while preserving source-backed governance.
...
- Testing Story evidence exists for SMA-REG-0001.

# STORY-SMA-MAC-0012-IMPL: Implement US CPI

Type: Story

Story Id: STORY-SMA-MAC-0012-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-MAC-0012
...
Feature: US CPI capability

Business Goal: Deliver implementation story coverage for US CPI while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for US CPI.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-MAC-0012.
...
- Implementation Story evidence exists for SMA-MAC-0012.

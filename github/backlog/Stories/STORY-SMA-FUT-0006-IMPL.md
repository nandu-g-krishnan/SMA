# STORY-SMA-FUT-0006-IMPL: Implement Futures contracts, basis, rollover, cost of carry, margin, MTM

Type: Story

Story Id: STORY-SMA-FUT-0006-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-FUT-0006
...
Architecture Component: Futures Analytics Engine

Initiative: I04 Options and Futures Platform

Epic: I04-E04 Futures analytics; I04-E05 Margin and expiry risk

Feature: Contract master, basis tracker, rollover, cost of carry, MTM risk

Business Goal: Deliver implementation story coverage for Futures contracts, basis, rollover, cost of carry, margin, MTM while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Futures contracts, basis, rollover, cost of carry, margin, MTM.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-FUT-0006.
...
- Implementation Story evidence exists for SMA-FUT-0006.

# STORY-SMA-MAC-0013-IMPL: Implement US NFP

Type: Story

Story Id: STORY-SMA-MAC-0013-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-MAC-0013
...
Feature: US NFP capability

Business Goal: Deliver implementation story coverage for US NFP while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for US NFP.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-MAC-0013.
...
- Implementation Story evidence exists for SMA-MAC-0013.

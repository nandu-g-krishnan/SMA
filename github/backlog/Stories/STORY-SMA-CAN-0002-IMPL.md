# STORY-SMA-CAN-0002-IMPL: Implement Doji

Type: Story

Story Id: STORY-SMA-CAN-0002-IMPL
...
Feature: Doji capability

Business Goal: Deliver implementation story coverage for Doji while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Doji.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-CAN-0002.
...
- Implementation Story evidence exists for SMA-CAN-0002.

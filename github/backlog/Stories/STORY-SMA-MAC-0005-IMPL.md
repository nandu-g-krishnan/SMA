# STORY-SMA-MAC-0005-IMPL: Implement Global Indices

Type: Story

Story Id: STORY-SMA-MAC-0005-IMPL

Story Type: Implementation Story

KnowledgeIds: SMA-MAC-0005
...
Architecture Component: Macro Engine

Initiative: Macro Platform

Epic: Macro catalog coverage

Feature: Global Indices capability

Business Goal: Deliver implementation story coverage for Global Indices while preserving source-backed governance.

Functional Requirements:

- Use the authoritative source references for Global Indices.
...
- Store implementation, test, validation, documentation, and operational evidence against SMA-MAC-0005.
...
- Implementation Story evidence exists for SMA-MAC-0005.

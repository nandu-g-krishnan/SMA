# STORY-SMA-IND-0020-DOC: Document SMA

Type: Story

Story Id: STORY-SMA-IND-0020-DOC
...
Business Goal: Deliver documentation story coverage for SMA while preserving source-backed governance.
...
- Documentation Story evidence exists for SMA-IND-0020.

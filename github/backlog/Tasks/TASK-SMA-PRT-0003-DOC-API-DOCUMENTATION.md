# TASK-SMA-PRT-0003-DOC-API-DOCUMENTATION: API Documentation for Drawdown Control

Type: Task

Task Id: TASK-SMA-PRT-0003-DOC-API-DOCUMENTATION

Parent Story: STORY-SMA-PRT-0003-DOC
...
Objective: Complete api documentation evidence for STORY-SMA-PRT-0003-DOC.

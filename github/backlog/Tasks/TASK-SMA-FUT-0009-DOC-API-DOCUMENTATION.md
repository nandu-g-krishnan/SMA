# TASK-SMA-FUT-0009-DOC-API-DOCUMENTATION: API Documentation for Mark to Market

Type: Task

Task Id: TASK-SMA-FUT-0009-DOC-API-DOCUMENTATION

Parent Story: STORY-SMA-FUT-0009-DOC
...
Objective: Complete api documentation evidence for STORY-SMA-FUT-0009-DOC.

# TASK-SMA-PAT-0011-DOC-API-DOCUMENTATION: API Documentation for Head and Shoulders

Type: Task

Task Id: TASK-SMA-PAT-0011-DOC-API-DOCUMENTATION
...
Objective: Complete api documentation evidence for STORY-SMA-PAT-0011-DOC.

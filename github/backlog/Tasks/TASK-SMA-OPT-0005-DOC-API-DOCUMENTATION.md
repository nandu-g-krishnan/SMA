# TASK-SMA-OPT-0005-DOC-API-DOCUMENTATION: API Documentation for Implied Volatility

Type: Task

Task Id: TASK-SMA-OPT-0005-DOC-API-DOCUMENTATION

Parent Story: STORY-SMA-OPT-0005-DOC
...
Objective: Complete api documentation evidence for STORY-SMA-OPT-0005-DOC.

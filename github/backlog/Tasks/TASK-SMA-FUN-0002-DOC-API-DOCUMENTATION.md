# TASK-SMA-FUN-0002-DOC-API-DOCUMENTATION: API Documentation for Debt Equity

Type: Task

Task Id: TASK-SMA-FUN-0002-DOC-API-DOCUMENTATION

Parent Story: STORY-SMA-FUN-0002-DOC
...
Objective: Complete api documentation evidence for STORY-SMA-FUN-0002-DOC.

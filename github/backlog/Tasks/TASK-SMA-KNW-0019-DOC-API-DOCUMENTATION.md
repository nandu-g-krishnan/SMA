# TASK-SMA-KNW-0019-DOC-API-DOCUMENTATION: API Documentation for Trading psychology, journal, mistakes, discipline

Type: Task

Task Id: TASK-SMA-KNW-0019-DOC-API-DOCUMENTATION
...
Objective: Complete api documentation evidence for STORY-SMA-KNW-0019-DOC.

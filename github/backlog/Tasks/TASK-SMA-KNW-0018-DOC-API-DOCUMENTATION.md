# TASK-SMA-KNW-0018-DOC-API-DOCUMENTATION: API Documentation for Technical analysis assumptions: market discounts everything, market moves in trends, history repeats

Type: Task

Task Id: TASK-SMA-KNW-0018-DOC-API-DOCUMENTATION
...
Objective: Complete api documentation evidence for STORY-SMA-KNW-0018-DOC.

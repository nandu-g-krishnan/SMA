# TASK-SMA-VAL-0003-DOC-API-DOCUMENTATION: API Documentation for Intrinsic value and fair value

Type: Task

Task Id: TASK-SMA-VAL-0003-DOC-API-DOCUMENTATION
...
Objective: Complete api documentation evidence for STORY-SMA-VAL-0003-DOC.
